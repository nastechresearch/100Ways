...
AUD = "agent:inst-123"
ISS = "https://portal.nastechresearch.com"
...
def test_jwks_url_path_resolves_key(rsa_keys, monkeypatch):
    ...
    class FakeJWKClient:
        def __init__(self, url, **kwargs):
            assert url == "https://portal.nastechresearch.com/.well-known/jwks.json"
    ...
    claims = verify_nas_fire_token(
        ...
        jwks_or_key="https://portal.nastechresearch.com/.well-known/jwks.json",
        issuer=ISS,
    )
...
def test_jwks_client_sends_explicit_http_headers(monkeypatch):
    ...
    the dashboard-auth nastech/self_hosted providers)."""
    from plugins.cron_providers.chronos import verify as verify_mod
    ...
    url = "https://portal.nastechresearch.com/.well-known/jwks.json"
