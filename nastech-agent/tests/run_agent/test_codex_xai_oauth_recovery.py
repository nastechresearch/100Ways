...
3. Multi-turn replay of ``codex_reasoning_items`` (with
   ...
   reverted shortly after: xAI confirmed they explicitly want Nastech to
...
def test_codex_reasoning_replay_includes_encrypted_content_for_xai():
    ...
    want Nastech to thread encrypted reasoning back across turns for
...
def test_grok_4_3_context_length_is_1m():
    ...
    Nastech' substring-match fallback used to return 256k (from the
