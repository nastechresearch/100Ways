...
AlexKucera reported on Discord (2026-04-16) that after ``nastech update`` pulled
...
Opt-in — not part of default CI:
    NASTECH_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v

Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.nastech/.env).
"""
