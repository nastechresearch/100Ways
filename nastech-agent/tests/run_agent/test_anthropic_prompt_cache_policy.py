...
class TestQwenAlibabaFamily:
    ...
    def test_qwen_on_nastech_portal_caches_with_envelope_layout(self):
        # Nastech Portal Qwen takes the same envelope-layout cache_control
    ...
    def test_non_qwen_non_claude_on_nastech_portal_does_not_cache(self):
...
class TestNastechPortalAnthropicWire:
