...
class TestSend:
    ...
    async def test_send_posts_to_webhook(self):
        ...
        assert payload["markdown"]["title"] == "Nastech"
...
class TestMentionPatterns:
    ...
    def test_pattern_matches_text(self, monkeypatch):
        ...
        assert adapter._message_matches_mention_patterns("nastech please help") is True
        assert adapter._message_matches_mention_patterns("please nastech help") is False
