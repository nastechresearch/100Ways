...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/NastechResearch/nastech-agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via Nastech-created DM topic
