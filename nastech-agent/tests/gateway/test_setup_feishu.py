"""Tests for _setup_feishu() in nastech_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("nastech_cli.config.save_env_value", side_effect=mock_save), \
         patch("nastech_cli.config.get_env_value", side_effect=mock_get), \
         patch("nastech_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("nastech_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("nastech_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("nastech_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("nastech_cli.cli_output.print_header"), \
         patch("nastech_cli.cli_output.print_info"), \
         patch("nastech_cli.cli_output.print_success"), \
         patch("nastech_cli.cli_output.print_warning"), \
         patch("nastech_cli.cli_output.print_error"), \
