...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _nastech_home captured at module
    # import time — before the per-test NASTECH_HOME redirect applies. When the
