...
class TestAgentConfigSignature:
    ...
    def test_model_change_different_signature(self):
        ...
        runtime = {"api_key": "sk-test12345678", "base_url": "https://openrouter.ai/api/v1",
                    "provider": "openrouter"}
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["nastech-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-opus-4.6", runtime, ["nastech-telegram"], "")
        assert sig1 != sig2
    ...
    def test_same_token_prefix_different_full_token_changes_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt1, ["nastech-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt2, ["nastech-telegram"], "")
        assert sig1 != sig2
    ...
    def test_provider_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt1, ["nastech-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt2, ["nastech-telegram"], "")
        assert sig1 != sig2
...
class TestExtractCacheBustingConfig:
    ...
    def test_reads_compression_subkeys(self):
        ...
        assert out["compression.codex_app_server_auto"] == "nastech"
...
class TestAgentCacheLifecycle:
    ...
    def test_cache_hit_returns_same_agent(self):
        ...
        sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["nastech-telegram"], "")
...
class TestAgentConfigSignatureUserId:
    ...
    def test_signature_omits_user_id_when_absent(self):
        ...
        sig_implicit = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["nastech-telegram"], "",
        )
