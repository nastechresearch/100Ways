...
NASTECH_MAX_ITERATIONS, but a later per-turn load_dotenv(..., override=True)
can restore a stale .env NASTECH_MAX_ITERATIONS value before the next turn.
"""
