...
The unit tests in tests/nastech_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned nastech-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/nastech")
from nastech_cli.service_manager import S6ServiceManager
