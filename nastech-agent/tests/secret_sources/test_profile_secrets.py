...
def _apply(secrets, cfg_extra=None, home=Path("/tmp/x/.nastech"), env=None):
...
PROFILE_HOME = Path("/home/u/.nastech/profiles/milla")
...
def test_hyphenated_profile_name_matches_underscore_suffix():
    _, env = _apply(
        ...
        home=Path("/home/u/.nastech/profiles/my-bot"),
    )
