...
COMMON_NASTECH_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_nastech_tools_have_kind(self):
        """Every common nastech tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_NASTECH_TOOLS:
...
class TestBuildToolTitle:
    ...
    def test_execute_code_title_includes_first_code_line(self):
        ...
        assert title == "python: from nastech_tools import terminal"
