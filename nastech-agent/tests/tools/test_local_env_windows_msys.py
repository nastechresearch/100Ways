...
class TestBashSafePath:
    ...
    def test_quote_bash_path_quotes_mixed_windows_path(self):
        quoted = _quote_bash_path(
            r"C:\Users\Alexander\AppData\Local\Temp\nastech-snap-abc.sh"
        )
        assert "/c/Users/Alexander/AppData/Local/Temp/nastech-snap-abc.sh" in quoted
...
class TestWindowsMsysPathconvDefaults:
    ...
    def test_nastech_subprocess_env_sets_msys_no_pathconv_on_windows(self):
...
class TestWrapCommandWindowsNativeCwd:
    ...
    def test_init_session_bootstrap_rewrites_backslash_snapshot_paths(self, monkeypatch):
        ...
        snap = r"C:\Users\Alexander\AppData\Local\Temp\nastech-snap-deadbeef.sh"
        ...
        assert "/c/Users/Alexander/AppData/Local/Temp/nastech-snap-deadbeef.sh" in script
