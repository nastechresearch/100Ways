...
(nastech_cli/config.py docstring; precedent: #74211, #74322).

These tests drive the REAL functions against a temp NASTECH_HOME config
(AGENTS.md: E2E with real imports), not mocks of the seam under test.
"""
import pytest

import nastech_cli.config as hc
