...
def test_postprocess_adds_agent_visible_image_for_active_ssh_env(monkeypatch, tmp_path):
    ...
    image_dir = nastech_home / "cache" / "images"
    ...
    assert result["agent_visible_image"] == (
        "/home/remotesshuser/.nastech/cache/images/xai_grok-imagine-image_test.jpg"
    )
...
def test_concurrent_image_results_preserve_shared_remote_sync_state(monkeypatch, tmp_path):
    ...
    def get_files():
        return [
            (
                str(path),
                f"/home/remote/.nastech/cache/images/{path.name}",
            )
    ...
    assert set(sync_manager._synced_files) == {
        "/home/remote/.nastech/cache/images/first.png",
        "/home/remote/.nastech/cache/images/second.png",
    }
...
def test_handle_image_generate_postprocesses_plugin_result(monkeypatch, tmp_path):
    ...
    assert result["agent_visible_image"] == "/home/remote/.nastech/cache/images/plugin.png"
