...
class TestTerminalRequirements:
    ...
    def test_terminal_and_execute_code_tools_resolve_for_managed_modal(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(terminal_tool_module, "managed_nastech_tools_enabled", lambda: True)
...
class TestCheckFnTransientFailureSuppression:
    ...
    def test_profile_scoped_availability_does_not_cross_multiplex_profiles(
        ...
        try:
            home_a = set_nastech_home_override(str(profile_a))
            ...
            try:
                ...
                reset_nastech_home_override(home_a)

            home_b = set_nastech_home_override(str(profile_b))
            ...
            try:
                ...
                reset_nastech_home_override(home_b)
