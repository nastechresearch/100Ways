...
class TestSSHBulkUpload:
    ...
    def test_mkdir_batched_into_single_call(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.nastech/skills/a.txt"),
            (str(f2), "/home/testuser/.nastech/credentials/b.txt"),
        ]
        ...
        assert "/home/testuser/.nastech/skills" in mkdir_str
        assert "/home/testuser/.nastech/credentials" in mkdir_str
    ...
    def test_staging_symlinks_mirror_remote_layout(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.nastech/skills/my_skill.md"),
        ]
    ...
    def test_bulk_upload_never_stages_remote_home_prefix(self, mock_env, tmp_path):
        ...
        files = [(str(f1), "/home/testuser/.nastech/cache/nested.txt")]
    ...
    def test_timeout_kills_both_processes(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "t.txt"
        f1.write_text("t")
        files = [(str(f1), "/home/testuser/.nastech/skills/t.txt")]
...
class TestSSHBulkUploadEdgeCases:
    ...
    def test_ssh_popen_failure_kills_tar(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "e.txt"
        f1.write_text("e")
        files = [(str(f1), "/home/testuser/.nastech/skills/e.txt")]
