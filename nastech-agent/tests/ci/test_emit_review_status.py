...
def test_ci_review_status_links_to_each_sensitive_file_change():
    results = _mod.build_results(
        ...
        repo_url="https://github.com/nastechresearch/nastech-agent",
        base_sha="base456",
        head_sha="abc123",
    )
    ...
    assert results[0]["detail"] == (
        ...
        "- [`.github/workflows/ci.yml`](https://github.com/nastechresearch/nastech-agent/compare/base456...abc123#diff-b803fcb7f17ed9235f1e5cb1fcd2f5d3b2838429d4368ae4c57ce4436577f03f)\n"
        "- [`apps/desktop/eslint.config.mjs`](https://github.com/nastechresearch/nastech-agent/compare/base456...abc123#diff-a45471520795db6e46840d1ba2a82c1f8a2841039bd60fb50624488c5f192438)"
    )
