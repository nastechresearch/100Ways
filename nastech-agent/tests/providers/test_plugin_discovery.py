...
Verifies that:
 ...
 2. User plugins at $NASTECH_HOME/plugins/model-providers/<name>/ override bundled
...
def _clear_provider_caches():
    ...
    for mod in list(sys.modules.keys()):
        if (
            ...
            or mod.startswith("_nastech_user_provider")
        ):
            del sys.modules[mod]
