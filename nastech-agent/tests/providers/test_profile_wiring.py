...
class TestNastechProfileParity:
    def test_tags(self, transport):
        legacy = transport.build_kwargs(
            model="nastech-3", messages=_msgs(), tools=None, provider_profile=get_provider_profile("nastech"),
        )
        profile = transport.build_kwargs(
            model="nastech-3", messages=_msgs(), tools=None,
            provider_profile=get_provider_profile("nastech"),
        )
