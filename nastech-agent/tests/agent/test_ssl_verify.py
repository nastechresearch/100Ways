...
_CA_ENV_VARS = ("NASTECH_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE")
...
def test_nastech_ca_bundle_returns_ssl_context(clean_ca_env, monkeypatch):
    monkeypatch.setenv("NASTECH_CA_BUNDLE", certifi.where())
