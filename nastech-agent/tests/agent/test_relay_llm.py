...
def test_stream_uses_rewritten_request_and_post_intercept_chunks(relay_turn):
    ...
    try:
        ...
        relay.intercepts.deregister_llm_stream_execution("nastech-test-stream")
        relay.intercepts.deregister_llm_request("nastech-test-request")
