...
from nastech_cli.observability.shared_metrics_contract import MODEL_ROUTE_METRIC
from nastech_cli.observability.shared_metrics_subscriber import SharedMetricsSubscriber
...
def test_auxiliary_provider_fallback_records_one_terminal_model_route(
    ...
    assert snapshot[0]["resource"]["nastech_version"] == "test-version"
