...
class TestPluginContextEngineSlot:
    ...
    def test_register_engine(self):
        from nastech_cli.plugins import PluginManager, PluginContext, PluginManifest
        mgr = PluginManager()
    ...
    def test_get_plugin_context_engine(self):
        from nastech_cli.plugins import PluginManager, get_plugin_context_engine
...
class TestInitAgentDoesNotMutatePluginSingleton:
    ...
    def test_child_init_does_not_corrupt_parent_singleton(self, monkeypatch):
        ...
        try:
            ...
            import copy
            from nastech_cli.plugins import get_plugin_context_engine
