...
def _base_headers(**overrides) -> dict:
    ...
    h = {
        "x-nastech-credits-version": "1",
        "x-nastech-credits-remaining-micros": micros(0),
        "x-nastech-credits-remaining-usd": "0.00",
        "x-nastech-credits-subscription-micros": micros(0),
        "x-nastech-credits-subscription-usd": "0.00",
        "x-nastech-credits-rollover-micros": micros(0),
        "x-nastech-credits-purchased-micros": micros(0),
        "x-nastech-credits-purchased-usd": "0.00",
        "x-nastech-tool-pool-micros": micros(0),
        "x-nastech-tool-pool-gated-off": "false",
        "x-nastech-credits-denominator-kind": "none",
        "x-nastech-credits-paid-access": "true",
        "x-nastech-credits-as-of-ms": "1717000000000",
    }
    h.update(overrides)
    return h
...
HEALTHY_HEADERS = _base_headers(
    **{
        "x-nastech-credits-remaining-micros": micros(30.34),
        "x-nastech-credits-remaining-usd": "30.34",
        "x-nastech-credits-subscription-micros": micros(18.00),
        "x-nastech-credits-subscription-usd": "18.00",
        "x-nastech-credits-subscription-limit-micros": micros(20.00),
        "x-nastech-credits-subscription-limit-usd": "20.00",
        "x-nastech-credits-rollover-micros": micros(0),
        "x-nastech-credits-purchased-micros": micros(12.34),
        "x-nastech-credits-purchased-usd": "12.34",
        "x-nastech-tool-pool-micros": micros(2.00),
        "x-nastech-tool-pool-gated-off": "true",
        "x-nastech-credits-denominator-kind": "subscription_cap",
        "x-nastech-credits-paid-access": "true",
    }
)
...
SUB_90PCT_HEADERS = _base_headers(
    **{
        "x-nastech-credits-remaining-micros": micros(2.00),
        "x-nastech-credits-remaining-usd": "2.00",
        "x-nastech-credits-subscription-micros": micros(2.00),
        "x-nastech-credits-subscription-usd": "2.00",
        "x-nastech-credits-subscription-limit-micros": micros(20.00),
        "x-nastech-credits-subscription-limit-usd": "20.00",
        "x-nastech-credits-purchased-micros": micros(0),
        "x-nastech-credits-purchased-usd": "0.00",
...
GRANT_EXHAUSTED_HEADERS = _base_headers(
    **{
        "x-nastech-credits-remaining-micros": micros(12.34),
        "x-nastech-credits-remaining-usd": "12.34",
        "x-nastech-credits-subscription-micros": micros(0),
        "x-nastech-credits-subscription-usd": "0.00",
        "x-nastech-credits-subscription-limit-micros": micros(20.00),
        "x-nastech-credits-subscription-limit-usd": "20.00",
...
PURCHASED_ONLY_HEADERS = _base_headers(
    **{
        "x-nastech-credits-remaining-micros": micros(30.00),
        "x-nastech-credits-remaining-usd": "30.00",
        "x-nastech-credits-subscription-micros": micros(0),
        "x-nastech-credits-subscription-usd": "0.00",
        "x-nastech-credits-purchased-micros": micros(30.00),
        "x-nastech-credits-purchased-usd": "30.00",
        "x-nastech-credits-denominator-kind": "none",
        "x-nastech-credits-paid-access": "true",
...
TOOL_POOL_FREE_HEADERS = _base_headers(
    **{
        "x-nastech-credits-remaining-micros": micros(0.05),
        "x-nastech-credits-remaining-usd": "0.05",
        "x-nastech-tool-pool-micros": micros(0.05),
        "x-nastech-tool-pool-gated-off": "false",
        "x-nastech-credits-paid-access": "true",
    }
)
...
DEPLETED_HEADERS = _base_headers(
    **{
        ...
        "x-nastech-credits-purchased-micros": micros(0),
        "x-nastech-credits-purchased-usd": "0.00",
        "x-nastech-credits-paid-access": "false",
        "x-nastech-credits-disabled-reason": "out_of_credits",
    }
)
...
DEBT_HEADERS = _base_headers(
    **{
        "x-nastech-credits-remaining-micros": micros(0),
        "x-nastech-credits-remaining-usd": "0.00",
        "x-nastech-credits-subscription-micros": str(-5_000_000),
        "x-nastech-credits-subscription-usd": "-5.00",
        "x-nastech-credits-purchased-micros": micros(0),
        "x-nastech-credits-purchased-usd": "0.00",
        "x-nastech-credits-paid-access": "false",
    }
...
class TestVersionValidation:
    def test_version_string_1_parses(self):
        headers = _base_headers(**{"x-nastech-credits-version": "1"})
        state = parse_credits_headers(headers)
        assert state is not None
    ...
    def test_version_greater_than_1_warns_once(self, caplog):
        ...
        try:
            ...
            headers = _base_headers(**{"x-nastech-credits-version": "3"})
...
class TestBoolStringTrap:
    ...
    def test_paid_access_string_false_means_depleted(self):
        ...
        headers = _base_headers(**{"x-nastech-credits-paid-access": "false"})
        state = parse_credits_headers(headers)
        assert state is not None
        assert state.paid_access is False
        assert state.depleted is True
    ...
    def test_paid_access_string_true_means_not_depleted(self):
        headers = _base_headers(**{"x-nastech-credits-paid-access": "true"})
        state = parse_credits_headers(headers)
        assert state is not None
        assert state.paid_access is True
        assert state.depleted is False
...
class TestToolPoolOptional:
    """x-nastech-tool-pool-* headers are optional; absent → defaults; present-but-malformed → miss."""

    def _no_tool_pool_headers(self) -> dict:
        """Base headers with BOTH tool-pool headers removed."""
        h = _base_headers()
        h.pop("x-nastech-tool-pool-micros", None)
        h.pop("x-nastech-tool-pool-gated-off", None)
        return h
...
class TestHalfPairLimit:
    ...
    def test_full_pair_present_parsed_correctly(self):
        ...
        headers = _base_headers(
            **{
                "x-nastech-credits-subscription-micros": micros(10.00),
                "x-nastech-credits-subscription-usd": "10.00",
                "x-nastech-credits-subscription-limit-micros": micros(20.00),
                "x-nastech-credits-subscription-limit-usd": "20.00",
                "x-nastech-credits-denominator-kind": "subscription_cap",
            }
...
class TestNegativeValues:
    def test_negative_remaining_micros_returns_none(self):
        headers = _base_headers(**{"x-nastech-credits-remaining-micros": "-1000"})
        assert parse_credits_headers(headers) is None
    ...
    def test_negative_limit_micros_returns_none(self):
        headers = _base_headers(
            **{
                "x-nastech-credits-subscription-limit-micros": "-1000",
                "x-nastech-credits-subscription-limit-usd": "-0.00",
                "x-nastech-credits-denominator-kind": "subscription_cap",
            }
        )
        assert parse_credits_headers(headers) is None
    ...
    def test_negative_subscription_accepted(self):
        ...
        headers = _base_headers(**{"x-nastech-credits-subscription-micros": "-5000000",
                                   "x-nastech-credits-subscription-usd": "-5.00"})
        state = parse_credits_headers(headers)
        assert state is not None
...
class TestUsdValidation:
    def test_valid_usd_format(self):
        headers = _base_headers(**{"x-nastech-credits-remaining-usd": "18.00"})
        state = parse_credits_headers(headers)
        assert state is not None
    ...
    def test_usd_one_decimal_returns_none(self):
        ...
        headers = _base_headers(**{"x-nastech-credits-remaining-usd": "18.0"})
        assert parse_credits_headers(headers) is None
    ...
    def test_usd_negative_valid(self):
        ...
        headers = _base_headers(
            **{
                "x-nastech-credits-subscription-micros": "-5000000",
                "x-nastech-credits-subscription-usd": "-5.00",
            }
        )
        state = parse_credits_headers(headers)
...
class TestMicrosValidation:
    def test_non_int_micros_string_returns_none(self):
        headers = _base_headers(**{"x-nastech-credits-remaining-micros": "abc"})
        assert parse_credits_headers(headers) is None
...
class TestAsOfMs:
    def test_junk_as_of_ms_returns_none(self):
        headers = _base_headers(**{"x-nastech-credits-as-of-ms": "not-a-timestamp"})
        assert parse_credits_headers(headers) is None

    def test_valid_as_of_ms(self):
        headers = _base_headers(**{"x-nastech-credits-as-of-ms": "1717000000000"})
        state = parse_credits_headers(headers)
        assert state is not None
...
class TestDenominatorKind:
    ...
    def test_none_valid(self):
        headers = _base_headers(**{"x-nastech-credits-denominator-kind": "none"})
        state = parse_credits_headers(headers)
        assert state is not None
        assert state.denominator_kind == "none"

    def test_invalid_denominator_kind_returns_none(self):
        headers = _base_headers(**{"x-nastech-credits-denominator-kind": "invalid_kind"})
        assert parse_credits_headers(headers) is None
...
class TestZeroDivisionGuard:
    def test_subscription_limit_zero_used_fraction_is_none(self):
        ...
        headers = _base_headers(
            **{
                "x-nastech-credits-subscription-limit-micros": "0",
                "x-nastech-credits-subscription-limit-usd": "0.00",
                "x-nastech-credits-denominator-kind": "subscription_cap",
            }
        )
...
class TestUnknownHeaders:
    def test_unknown_extra_header_ignored(self):
        headers = {
            **_base_headers(),
            "x-nastech-credits-future-field": "some-value",
            "x-request-id": "abc123",
        }
        state = parse_credits_headers(headers)
        assert state is not None
...
class TestHeaderNormalization:
    ...
    def test_mixed_case_headers_parsed(self):
        headers = {
            "X-Nastech-Credits-Version": "1",
            "X-Nastech-Credits-Remaining-Micros": micros(5.00),
            "X-Nastech-Credits-Remaining-Usd": "5.00",
            "X-Nastech-Credits-Subscription-Micros": micros(5.00),
            "X-Nastech-Credits-Subscription-Usd": "5.00",
            "X-Nastech-Credits-Rollover-Micros": "0",
            "X-Nastech-Credits-Purchased-Micros": "0",
            "X-Nastech-Credits-Purchased-Usd": "0.00",
            "X-Nastech-Tool-Pool-Micros": "0",
            "X-Nastech-Tool-Pool-Gated-Off": "false",
            "X-Nastech-Credits-Denominator-Kind": "none",
            "X-Nastech-Credits-Paid-Access": "true",
            "X-Nastech-Credits-As-Of-Ms": "1717000000000",
