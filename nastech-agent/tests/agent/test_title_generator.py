...
class TestGenerateTitle:
    ...
    def test_title_language_reads_config(self):
        ...
        with patch("nastech_cli.config.load_config", return_value=cfg), patch("nastech_cli.config.load_config_readonly", return_value=cfg):
            assert _title_language() == "French"
        with patch("nastech_cli.config.load_config", return_value={}), patch("nastech_cli.config.load_config_readonly", return_value={}):
            assert _title_language() == ""
        with patch("nastech_cli.config.load_config", side_effect=RuntimeError("bad config")), \
         patch("nastech_cli.config.load_config_readonly", side_effect=RuntimeError("bad config")):
            assert _title_language() == ""
