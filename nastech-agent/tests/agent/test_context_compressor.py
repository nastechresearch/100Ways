...
class TestSummarizeToolResultClarify:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # nastech_cli/oneshot.py no-user callback
    ...
    def test_live_oneshot_producer_is_recognized_as_sentinel(self):
        ...
        from nastech_cli.oneshot import _oneshot_clarify_callback
...
class TestAuthFailureAborts:
    ...
    Real incident: a nastech token pointed at a stale staging inference URL
    ...
    def test_missing_provider_api_key_preserves_original_messages(self):
        ...
        err = RuntimeError(
            ...
            "to a different provider with nastech model."
        )
        with patch(
