"""Tests for the nastech-tools-as-MCP server module surface.
...
from agent.transports.nastech_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import nastech_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.nastech_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.nastech_tools_mcp_server as m
