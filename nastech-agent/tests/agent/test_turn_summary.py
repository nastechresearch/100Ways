...
def _make_cli(**overrides):
    ...
    Avoids constructing NastechCLI (which loads config, sessions, and a
    ...
    class _Stub:
        ...
        _turn_summary_is_active = cli_module.NastechCLI._turn_summary_is_active
        _turn_summary_begin = cli_module.NastechCLI._turn_summary_begin
        _turn_summary_record = cli_module.NastechCLI._turn_summary_record
        _turn_summary_emit = cli_module.NastechCLI._turn_summary_emit
        _spinner_token_flow = cli_module.NastechCLI._spinner_token_flow
        _render_spinner_text = cli_module.NastechCLI._render_spinner_text
