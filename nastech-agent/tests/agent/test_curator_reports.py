...
Reports live under ``~/.nastech/logs/curator/{YYYYMMDD-HHMMSS}/`` alongside
...
def curator_env(tmp_path, monkeypatch):
    """Isolated NASTECH_HOME with a skills/ dir + reset curator module state."""
...
def curator_env_with_cron(curator_env, monkeypatch):
    ...
    monkeypatch.setattr(jobs_mod, "NASTECH_DIR", home)
