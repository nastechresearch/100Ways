...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("nastech_cli.config.get_config_path", return_value=config_path), \
             patch("nastech_cli.config.ensure_nastech_home"):
    ...
    def test_ensure_nastech_home_sets_0700(self):
        home = Path(self.tmpdir) / ".nastech"
