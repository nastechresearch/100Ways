...
def test_update_job_rejects_no_agent_on_monitor_job(nastech_env):
...
def test_update_job_rejects_adding_monitor_to_no_agent_job(nastech_env):
    from cron.jobs import create_job, update_job
...
def test_update_job_rejects_second_monitor_source(nastech_env):
    from cron.jobs import create_job, update_job
...
def test_update_job_allows_clearing_monitor_then_no_agent(nastech_env):
...
def test_update_job_unrelated_fields_skip_mode_validation(nastech_env):
