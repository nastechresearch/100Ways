...
class TestGoogleWorkspaceCredentialFiles:
    ...
    def test_entries_are_registered_when_files_exist(self, tmp_path):
        ...
        (nastech_home / "google_client_secret.json").write_text("{}")
        ...
        try:
            ...
            assert "/root/.nastech/google_token.json" in container_paths
            assert "/root/.nastech/google_client_secret.json" in container_paths
        finally:
            clear_credential_files()
