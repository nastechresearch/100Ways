...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and nastech-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # nastech-agent (tests/skills/)
]
