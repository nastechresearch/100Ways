"""Tests for `nastech curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated NASTECH_HOME with real agent-created skills on disk."""
    ...
    from nastech_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import nastech_cli.curator as curator_cli
