...
The main() function in nastech_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `nastech -c model`
...
def _build_parser():
    """Build a minimal replica of the nastech top-level parser."""
