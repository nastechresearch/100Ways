...
class TestTencentTokenhubModelCatalog:
    ...
    def test_default_model(self):
        from nastech_cli.models import get_default_model_for_provider
        assert get_default_model_for_provider("tencent-tokenhub") == "hy3-preview"


# =============================================================================
# CANONICAL_PROVIDERS (nastech model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / Nastech Portal curated lists
# =============================================================================
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from nastech_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from nastech_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in NASTECH_OVERLAYS
        overlay = NASTECH_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from nastech_cli.providers import NASTECH_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = NASTECH_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_alias_known(self, alias):
        from nastech_cli.models import _KNOWN_PROVIDER_NAMES
