...
def _seed_memory(nastech_home, memory_text="", user_text=""):
    mem_dir = nastech_home / "memories"
...
def _seed_skill(nastech_home, name, description):
    skill_dir = nastech_home / "skills" / "demo" / name
...
def test_runs_offline_without_credentials(isolated_home, monkeypatch):
    ...
    for var in ("OPENROUTER_API_KEY", "OPENAI_API_KEY", "NASTECH_API_KEY",
                "ANTHROPIC_API_KEY"):
