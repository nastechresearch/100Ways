"""Tests for nastech_cli.copilot_auth — Copilot token validation and resolution."""
...
class TestTokenValidation:
    ...
    def test_classic_pat_rejected(self):
        from nastech_cli.copilot_auth import validate_copilot_token
...
class TestResolveToken:
    ...
    def test_gh_cli_classic_pat_raises(self, monkeypatch):
        ...
        with patch("nastech_cli.copilot_auth._try_gh_cli_token", return_value="ghp_classic"):
...
class TestRequestHeaders:
    ...
    def test_default_headers_include_openai_intent(self):
        ...
        assert headers["User-Agent"] == "NastechAgent/1.0"
