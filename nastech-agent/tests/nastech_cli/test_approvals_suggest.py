"""Tests for ``nastech approvals suggest`` (nastech_cli/approvals_suggest.py).

Approval history in Nastech is implied, not ledgered: the session DB
...
from nastech_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
