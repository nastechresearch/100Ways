...
The notice prints the most recent curator run summary on `nastech update`,
...
session start) so users normally never see the rename map. `nastech update`
