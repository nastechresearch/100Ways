...
class TestStripOptionalSystemdDirectives:
    def test_removes_restart_max_delay_sec(self):
        from nastech_cli.gateway import _strip_optional_systemd_directives
        text = """[Service]
Restart=always
RestartSec=5
...
"""
    ...
    def test_full_unit_comparison(self):
        ...
        installed = """[Unit]
Description=Nastech Gateway
After=network-online.target

[Service]
Type=simple
ExecStart=/usr/bin/python -m nastech_cli.main gateway run
Restart=always
RestartSec=5
KillMode=mixed
KillSignal=SIGTERM
...
"""
        ...
        unit_file = tmp_path / "nastech-gateway.service"
