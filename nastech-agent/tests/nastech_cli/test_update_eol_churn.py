"""Regression: ``nastech update`` should take a managed checkout off autocrlf=true.
...
``nastech update`` has to repair them.
...
from nastech_cli.update_cmd import _normalize_managed_eol
