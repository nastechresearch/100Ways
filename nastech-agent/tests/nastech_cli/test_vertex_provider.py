...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (nastech_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_nastech_overlays():
    """nastech_cli.providers.get_provider("vertex") backs
