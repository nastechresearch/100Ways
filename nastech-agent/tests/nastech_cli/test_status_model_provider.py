"""Tests for nastech_cli.status model/provider display."""
...
def _patch_common_status_deps(monkeypatch, status_mod, tmp_path, *, openai_base_url=""):
    ...
    monkeypatch.setattr(
        auth_mod, "get_nastech_auth_status_local", lambda: {}, raising=False
    )
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "nastech_cli.models.probe_lmstudio_models",
