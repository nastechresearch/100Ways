"""Tests for the specifier module + `nastech kanban specify` CLI surface.
...
from nastech_cli import kanban as kanban_cli
from nastech_cli import kanban_db as kb
from nastech_cli import kanban_specify as spec
...
def _run_cli(*argv: str) -> int:
    """Invoke the `nastech kanban …` argparse surface directly."""
