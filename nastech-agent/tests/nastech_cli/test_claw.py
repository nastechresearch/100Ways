"""Tests for nastech claw commands."""
...
from nastech_cli import claw as claw_mod
...
class TestCmdMigrate:
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors OpenClaw's migrate-nastech
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.nastech/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.nastech/memories/MEMORY.md"},
