"""Tests for `_can_open_graphical_browser()` in nastech_cli.auth.

Guards the fix for the May 2026 report where `nastech auth add xai-oauth`
...
from nastech_cli.auth import _can_open_graphical_browser
