...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`nastech_cli.slash_exec.EXECUTORS`, and
...
from nastech_cli.commands import COMMAND_REGISTRY, resolve_command
from nastech_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
