...
import pytest
from nastech_cli.config import _expand_env_vars, load_config
...
class TestLoadConfigExpansion:
    def test_load_config_expands_env_vars(self, tmp_path, monkeypatch):
        ...
        # nastech_cli.config, making string-target monkeypatches hit a different
...
class TestLoadConfigCacheEnvStaleness:
    ...
    environment (#58514): a load before load_nastech_dotenv() runs, or an env
