...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_nastech_active_label(self, monkeypatch):
        from nastech_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config, **kwargs: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_nastech=True)}
            ),
        )
        ...
        nastech_row = {
            ...
            "managed_nastech_feature": "image_gen",
        }
        openai_row = {
            "name": "OpenAI",
        ...
        assert tools_config._is_provider_active(nastech_row, config) is False
