...
See: NastechResearch/nastech-agent#7622
"""
...
_GATEWAY_CMD = "python -m nastech_cli.main gateway run"
...
class TestProcFallback:
    ...
    def test_detects_gateway_pid_via_proc(self):
        my_pid = os.getpid()
        entries = {
            my_pid: "python -m nastech_cli.main",   # own process — excluded
            12345: _GATEWAY_CMD,
            99999: _OTHER_CMD,
        }
        ...
        with (
            ...
            patch("nastech_cli.gateway._get_ancestor_pids", return_value=set()),
