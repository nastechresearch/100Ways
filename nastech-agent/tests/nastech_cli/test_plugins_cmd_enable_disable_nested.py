...
the *mutation* side: `nastech plugins enable/disable` must resolve a bare name
...
class TestResolvePluginKey:
    @patch("nastech_cli.plugins.get_bundled_plugins_dir")
    @patch("nastech_cli.plugins_cmd._plugins_dir")
    def test_full_key_resolves_to_itself(self, mock_user, mock_bundled, nested_plugin_env):
        from nastech_cli.plugins_cmd import _resolve_plugin_key
...
class TestEnableDisableNested:
    @patch("nastech_cli.plugins.get_bundled_plugins_dir")
    @patch("nastech_cli.plugins_cmd._plugins_dir")
    @patch("nastech_cli.plugins_cmd._save_disabled_set")
    @patch("nastech_cli.plugins_cmd._save_enabled_set")
    @patch("nastech_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("nastech_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestEnableToolOverrideConsent:
    ...
    @patch("nastech_cli.plugins.get_bundled_plugins_dir")
    @patch("nastech_cli.plugins_cmd._plugins_dir")
    @patch("nastech_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("nastech_cli.plugins_cmd._save_disabled_set")
    @patch("nastech_cli.plugins_cmd._save_enabled_set")
    @patch("nastech_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("nastech_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `nastech plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from nastech_cli.plugins_cmd import _run_composite_fallback
