...
def _clear_cache():
    ...
    import nastech_cli.models as mod
...
class TestGetCopilotModelContext:
    ...
    @patch("nastech_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("nastech_cli.models._urlopen_model_catalog_request")
    ...
    @patch("nastech_cli.models.fetch_github_model_catalog", return_value=[])
