...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("NASTECH_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test NASTECH_HOME."""
    monkeypatch.setenv("NASTECH_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # NASTECH_HOME patch the client/profile_dir fixtures installed.
