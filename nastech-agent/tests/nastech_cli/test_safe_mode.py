"""Tests for `nastech chat --safe-mode` isolation."""
...
_VARS = ("NASTECH_SAFE_MODE", "NASTECH_IGNORE_USER_CONFIG", "NASTECH_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["NASTECH_SAFE_MODE"] == "1"
        assert os.environ["NASTECH_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["NASTECH_IGNORE_RULES"] == "1"
        return True
