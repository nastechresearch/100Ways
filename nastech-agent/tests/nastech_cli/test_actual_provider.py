...
from nastech_cli.models import normalize_provider as normalize_model_provider
...
from nastech_cli.providers import normalize_provider as normalize_overlay_provider
