"""Tests for `nastech secrets bitwarden token` / `nastech secrets onepassword token`.
...
from nastech_cli import onepassword_secrets_cli as op_cli
from nastech_cli import secrets_cli as bw_cli
