"""Tests for the interactive session browser (`nastech sessions browse`).
...
from nastech_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """nastech sessions browse should be parseable."""
