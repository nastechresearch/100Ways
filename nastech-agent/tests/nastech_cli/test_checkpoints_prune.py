"""Tests for `nastech checkpoints prune`'s orphan confirmation flow.
...
_PRE_V2_ONLY_STATUS = {
    "projects": [],
    "pre_v2_projects": [
        {"path": "/home/user/.nastech/checkpoints/deadbeefcafebabe", "workdir": None, "exists": False},
    ],
}
...
_MIXED_STATUS = {
    ...
    "pre_v2_projects": [
        {"path": "/home/user/.nastech/checkpoints/deadbeefcafebabe", "workdir": "/gone/pre-v2-project", "exists": False},
    ],
}
...
def test_keep_orphans_skips_prompt(monkeypatch, capsys, status):
    import nastech_cli.checkpoints as checkpoints_cli
