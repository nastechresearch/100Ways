"""Regression: nastech doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at nastech_cli/doctor.py already covers
Anthropic with the right headers, so the pluggable profile must be
skipped by `_build_apikey_providers_list()`.

See: NastechResearch/nastech-agent#22346
"""
