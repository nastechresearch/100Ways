"""Session <-> workspace grouping key (nastech_state.workspace_key).

The key is what `nastech sessions list --workspace` groups/filters on. It is a
...
from nastech_state import workspace_key
