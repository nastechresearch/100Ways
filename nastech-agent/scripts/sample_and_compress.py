...
DEFAULT_DATASETS = [
    "NastechResearch/swe-terminus-agent-glm-kimi-minimax",
    "NastechResearch/nastech-agent-megascience-sft1",
    "NastechResearch/Nastech-Agent-Thinking-GLM-4.7-SFT2",
    "NastechResearch/Nastech-Agent-Thinking-GLM-4.7-SFT1",
    "NastechResearch/terminal-tasks-glm-nastech-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "NastechResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload NastechResearch/{output_name} {final_output}")
