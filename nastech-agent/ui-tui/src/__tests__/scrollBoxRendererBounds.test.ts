...
import { Box, renderSync, ScrollBox, type ScrollBoxHandle, Text } from '@nastech/ink'
import React, { useLayoutEffect, useRef } from 'react'
import { describe, expect, it, vi } from 'vitest'

import SourceBox from '../../packages/nastech-ink/src/ink/components/Box.js'
import SourceScrollBox from '../../packages/nastech-ink/src/ink/components/ScrollBox.js'
import SourceText from '../../packages/nastech-ink/src/ink/components/Text.js'
import type { DOMElement } from '../../packages/nastech-ink/src/ink/dom.js'
import Output from '../../packages/nastech-ink/src/ink/output.js'
import { scrollFastPathStats as sourceScrollFastPathStats } from '../../packages/nastech-ink/src/ink/render-node-to-output.js'
import { renderSync as renderSourceSync } from '../../packages/nastech-ink/src/ink/root.js'
