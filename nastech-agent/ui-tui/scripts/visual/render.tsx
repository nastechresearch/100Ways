 ...
 * across theme x background scenes to <tmpdir>/nastech-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@nastech/ink'
...
// The regenerated slate light_colors block from nastech_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/nastech-agent',
...
const setup = (bgHex: string) => {
  process.env.NASTECH_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
