 ...
 *
 * A public install can end up with `origin=git@github.com:NastechResearch/nastech-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/NastechResearch/nastech-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nastechresearch/nastech-agent'
