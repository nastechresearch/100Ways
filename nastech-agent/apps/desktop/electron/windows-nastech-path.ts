 ...
 *      venv\Scripts\nastech.exe (the console-script shim, written at the END
 ...
 * signals (venv python interpreter, venv nastech shim, bootstrap-complete
 * marker) — gating on just the nastech.exe console-script shim alone is the
