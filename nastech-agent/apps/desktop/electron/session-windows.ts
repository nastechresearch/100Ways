...
// by main.ts (`setBackgroundThrottling` driven by the merged `nastech:active-work`
...
// (the "Nastech idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Nastech" wake word has NO preceding click,
