 ...
 * plugins resolve `@nastech/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __NASTECH_PLUGIN_SDK__: sdk,
  __NASTECH_REACT__: React,
  __NASTECH_REACT_JSX__: jsxRuntime,
  __NASTECH_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@nastech/plugin-sdk': shimUrl('__NASTECH_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__NASTECH_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__NASTECH_REACT_JSX__'),
    react: shimUrl('__NASTECH_REACT__')
  }
