...
export interface Translations {
  ...
  settings: {
    ...
    toolsets: {
      ...
      useBackend: string
      nastechIncluded: string
      nastechAuthNeededTitle: string
      nastechAuthNeededMessage: (provider: string) => string
      nastechAuthSignIn: string
      nastechAuthDoneTitle: string
      nastechAuthDoneMessage: string
      nastechAuthFailed: string
