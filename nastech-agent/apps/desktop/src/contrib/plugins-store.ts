 ...
 * `<nastech home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'nastech.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'nastech.desktop.disabledPlugins.v1'
