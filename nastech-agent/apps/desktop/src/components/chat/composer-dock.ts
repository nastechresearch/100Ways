 ...
 *  smallest type, soft nastech shadow. Uses an explicit fill (not `--composer-fill`)
...
export const composerPanelCard = cn(
  'rounded-2xl border border-border/65 shadow-nastech text-[length:var(--conversation-tool-font-size)]',
