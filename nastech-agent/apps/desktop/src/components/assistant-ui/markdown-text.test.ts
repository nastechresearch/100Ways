...
describe('preprocessMarkdown', () => {
  ...
  it('does not swallow trailing emphasis asterisks into an autolinked url', () => {
    const input = '**PR opened: https://github.com/NastechResearch/nastech-agent/pull/12345**'
    ...
    expect(output).toContain('<https://github.com/NastechResearch/nastech-agent/pull/12345>')
