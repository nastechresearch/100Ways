  ...
  if (state.setupChoice) {
    return (
      <div className="fixed inset-0 z-(--z-setup) flex items-center justify-center bg-background/90 p-4 backdrop-blur-md">
        <div className="w-full max-w-2xl rounded-xl border border-(--stroke-nastech) bg-card p-8 shadow-nastech">
      ...
      <div className="fixed inset-0 z-(--z-setup) flex items-center justify-center bg-background/90 backdrop-blur-md">
        <div className="w-full max-w-xl rounded-xl border border-(--stroke-nastech) bg-card p-8 shadow-nastech">
          ...
          <div className="mt-4">
            ...
            <pre className="overflow-x-auto rounded-md border border-(--stroke-nastech) px-3 py-2.5 font-mono text-[12px]">
          ...
          <div className="flex-shrink-0 bg-card p-4">
            <div className="flex items-center justify-between gap-2">
              <span className="text-xs text-muted-foreground">
                ...
                <code className="font-mono text-(--ui-text-secondary)">%LOCALAPPDATA%\nastech\logs\</code>
              </span>
