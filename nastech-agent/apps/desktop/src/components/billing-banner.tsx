 ...
 * usable — it only offers recovery: Nastech opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_nastech ? copy.titleNastech : copy.titleProvider(block.provider_label)
