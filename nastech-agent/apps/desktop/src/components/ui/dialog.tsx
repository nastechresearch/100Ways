      ...
      <DialogPortal>
        ...
        >
          <DialogPortalContainerContext.Provider value={contentNode}>
            ...
            <div className="relative z-10 overflow-hidden rounded-xl border border-b-0 border-(--stroke-nastech) bg-(--ui-chat-bubble-background)">
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          'fixed left-1/2 top-1/2 z-(--z-modal) pointer-events-auto flex max-h-[85vh] -translate-x-1/2 -translate-y-1/2 flex-col rounded-xl border border-(--stroke-nastech) bg-(--ui-chat-bubble-background) text-[length:var(--conversation-text-font-size)] text-foreground shadow-nastech duration-200 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
          widthClass,
          className
        )}
        data-slot="dialog-content"
