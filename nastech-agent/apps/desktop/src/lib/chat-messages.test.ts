...
import type { SessionMessage } from '@/types/nastech'
...
describe('toChatMessages', () => {
  ...
  it('renders MEDIA tags as assistant attachment links', () => {
    const [message] = toChatMessages([
      {
        role: 'assistant',
        content: "MEDIA:/Users/brooklyn/.nastech/cache/audio/tts_20260501_222725.mp3\n\nhow's that sound?",
        timestamp: 1
      }
    ])

    expect(chatMessageText(message)).toBe(
      "[Audio: tts_20260501_222725.mp3](#media:%2FUsers%2Fbrooklyn%2F.nastech%2Fcache%2Faudio%2Ftts_20260501_222725.mp3)\n\nhow's that sound?"
    )
  })
  ...
  it('renders a native-vision turn as caption plus thumbnail, not raw placeholder text', () => {
    ...
    const ref = '@image:`/Users/me/Library/Application Support/Nastech/composer-images/a.png`'
