...
/** Nastech' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (nastech_constants.py). `none` is not a level: it's
...
/** Nastech' built-in level when neither the surface nor the profile config
