...
const TILES_KEY = 'nastech.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'nastech.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __NASTECH_LAYOUT_TREE__).
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__NASTECH_SESSION_TILES__ = {
