...
const POPOUT_STORAGE_KEY = 'nastech.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'nastech.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'nastech.desktop.composerPopout.position'
