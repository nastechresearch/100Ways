...
import type { NastechGitBranch } from '@/global'
...
const branchActionLabel = (branch: NastechGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<NastechGitBranch[]>([])
  ...
  const convert = async (branch: NastechGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
