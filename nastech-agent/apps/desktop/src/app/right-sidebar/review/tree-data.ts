import type { NastechReviewFile } from '@/global'
...
export function buildReviewFlatList(files: NastechReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: NastechReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
