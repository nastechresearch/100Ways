...
import type { SessionInfo, SessionMessage } from '@/types/nastech'
...
describe('collectArtifactsForSession', () => {
  ...
  it('resolves remote image artifact thumbnails through the desktop fs bridge', async () => {
    ...
    const path = '/Users/me/.nastech/skills/work-esab/references/images/manual-step03.jpeg'
    ...
    expect(api).toHaveBeenCalledWith({
      path: '/api/fs/read-data-url?path=%2FUsers%2Fme%2F.nastech%2Fskills%2Fwork-esab%2Freferences%2Fimages%2Fmanual-step03.jpeg'
    })
  })
})
