...
// over a solid Nastech-blue well and blends into it. This blue well is the ONLY place
// Nastech blue appears in the billing page — everything else stays on the app's own tokens.
const NASTECH_BLUE = '#0000f2'
...
/**
 * Small rounded thumbnail (~40px) rendering the tier art over a Nastech-blue well.
...
export function TierArt({ className, name, size = 40 }: { className?: string; name?: null | string; size?: number }) {
  ...
  return (
    <div
      ...
      style={{ background: NASTECH_BLUE, height: size, width: size }}
    >
      <img
        alt=""
