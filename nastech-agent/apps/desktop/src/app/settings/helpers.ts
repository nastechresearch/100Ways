...
import type { ConfigFieldSchema, NastechConfigRecord, ToolsetInfo } from '@/types/nastech'
...
export function getNested(obj: NastechConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: NastechConfigRecord, path: string, value: unknown): NastechConfigRecord {
...
function personalityOptions(config: NastechConfigRecord): string[] {
...
function commandProviderNames(config: NastechConfigRecord, section: 'tts' | 'stt'): string[] {
