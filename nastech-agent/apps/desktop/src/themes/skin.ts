/**
 * Nastech skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$NASTECH_HOME/skins/` (or a
 * built-in) resolved by `nastech_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Nastech authors from a prompt lights up all three surfaces from one file.
 *
...
import type { NastechSkin, SkinColors } from '@nastech/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: NastechSkin): DesktopTheme | null {
