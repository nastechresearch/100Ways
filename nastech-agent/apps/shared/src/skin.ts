/**
 * Canonical Nastech skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$NASTECH_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`nastech_cli/skin_engine.py`),
 ...
 *   • CLI     → `nastech_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
