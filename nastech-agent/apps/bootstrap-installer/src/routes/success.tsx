...
export default function Success() {
  ...
  return (
    <div className="nastech-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        <p className="m-0 text-center text-base leading-normal tracking-tight text-muted-foreground">
          ...
          <code className="font-mono text-sm text-foreground/80">nastech desktop</code>.
        </p>
      </div>
