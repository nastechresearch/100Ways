 ...
 *
 * Bracketed [ LABEL ], mono/uppercase, primary accent on a --stroke-nastech hairline.
...
export function HackeryButton({
  ...
  return (
    <button
      {...props}
      className={cn(
        'group inline-flex cursor-pointer items-center gap-2 rounded-md border border-(--stroke-nastech) px-6 py-2.5',
