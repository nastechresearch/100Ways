 ...
 *      (``@/lib/api``, ``@nastech-research/ui``, …). Deriving the type would
 ...
 *     (pulls @nastech-research/ui types into the contract) or is the loose
...
export interface NastechPluginSDK {
  ...
  /**
   * Shared UI primitives (Nastech DS / shadcn). Typed permissively at the
