...
import { Checkbox } from "@nastech-research/ui/ui/components/checkbox";
import { Select, SelectOption } from "@nastech-research/ui/ui/components/select";
import { Card, CardHeader, CardTitle, CardContent } from "@nastech-research/ui/ui/components/card";
import { Input } from "@nastech-research/ui/ui/components/input";
import { Label } from "@nastech-research/ui/ui/components/label";
import { Separator } from "@nastech-research/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@nastech-research/ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__NASTECH_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  ...
  window.__NASTECH_PLUGIN_SDK__ = {
    ...
    // window.__NASTECH_SESSION_TOKEN__ directly.
    authedFetch,
    ...
    // UI components — Nastech DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
