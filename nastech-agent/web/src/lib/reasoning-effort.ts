 ...
 *
 * Values mirror nastech_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Nastech default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Nastech' default when unset). */
