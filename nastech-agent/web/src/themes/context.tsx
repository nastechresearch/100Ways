...
const FONT_STORAGE_KEY = "nastech-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Nastech-blue rebrand.
  "lens-5i": "nastech-blue",
};
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Nastech Blue) doesn't leave its values behind when the user
