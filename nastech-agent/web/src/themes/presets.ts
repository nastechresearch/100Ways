...
/** Light mode — vivid Nastech-blue accents on a cream canvas. */
export const nastechBlueTheme: DashboardTheme = {
  name: "nastech-blue",
  label: "Nastech Blue",
  description: "Light mode — vivid Nastech-blue accents on cream canvas",
  palette: {
