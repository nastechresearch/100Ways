...
const PTY_ATTACH_TOKEN_KEY = "nastech.pty.token.chat";
...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    //      payloads upload to NASTECH_HOME/images then drive `/image`.
    //
    ...
    // must upload browser bytes to NASTECH_HOME/images, then drive `/image`
    ...
    void (async () => {
      ...
      // Profile-scoped chat: the PTY child gets NASTECH_HOME pointed at the
