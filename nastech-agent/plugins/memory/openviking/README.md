...
file URIs, such as
`viking://user/peers/nastech/memories/preferences/mem_abc123.md` or the canonical
`viking://user/default/peers/nastech/memories/preferences/mem_abc123.md`. Files
