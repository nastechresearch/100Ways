...
Built for [Nastech Agent](https://github.com/NastechResearch/nastech-agent). Usable in any coding agent. Canonical source lives here; synced to [`NastechResearch/nastech-agent/skills/creative/ascii-video`](https://github.com/NastechResearch/nastech-agent/tree/main/skills/creative/ascii-video) via PR.
