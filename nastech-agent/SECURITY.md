...
Report privately via [GitHub Security Advisories](https://github.com/NastechResearch/nastech-agent/security/advisories/new)
or **security@nastechresearch.com**. Do not open public issues for
...
- Environment details (`nastech version`, commit SHA, OS, Python
  version).
...
- **Documented break-glass settings.** Operator-selected trade-offs
  ...
  nastech-home security, and similar. Reports against those
