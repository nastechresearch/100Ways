...
`hey_nastech.onnx` / `hey_nastech.tflite` — the on-device "Hey Nastech" hotword
...
- **Label:** the model registers as `hey_nastech` (matches the filename).
