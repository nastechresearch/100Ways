...
```
Desktop app                Gateway (/auth/native/*)          Nastech Portal (IDP)
...
desktop app* and an OAuth client *to the upstream identity provider* (Nastech
...
brokerable OAuth provider registered (e.g. the bundled **Nastech** provider). No
...
- [Run Nastech with Nastech Portal](./run-nastech-with-nastech-portal.md)
