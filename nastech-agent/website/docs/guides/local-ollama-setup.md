...
```bash
# ~/.nastech/.env
NASTECH_API_TIMEOUT=1800   # 30 minutes — generous for slow local models
```
:::
...
Alternatively, edit `~/.nastech/config.yaml` directly:
...
2. Add to your `~/.nastech/config.yaml`:
