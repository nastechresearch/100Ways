...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/software-development/rest-graphql-debug` |
...
- Never hardcode tokens in scripts. Read from env (`os.environ["API_TOKEN"]`) or `${NASTECH_HOME:-~/.nastech}/.env`.
