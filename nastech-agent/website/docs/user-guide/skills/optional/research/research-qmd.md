...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/research/qmd` |
...
Nastech Agent via the native MCP client. This is the preferred
...
Then configure Nastech Agent to connect via HTTP:
