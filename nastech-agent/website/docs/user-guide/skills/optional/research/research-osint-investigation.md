...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/research/osint-investigation` |
...
# $NASTECH_OSINT_CACHE/icij/ (default: ~/.cache/nastech-osint/icij/).
...
# Set NASTECH_OSINT_UA=your-app/1.0 (your@email) to identify yourself
