...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/web-development/page-agent` |
...
- User wants **Nastech itself to drive a browser** → use Nastech' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
