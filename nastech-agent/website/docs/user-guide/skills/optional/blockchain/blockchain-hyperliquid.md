...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Nastech Agent |
| License | MIT |
...
The script reads `${NASTECH_HOME:-~/.nastech}/.env` for two optional defaults:
...
Helper script: `~/.nastech/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.nastech/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${NASTECH_HOME:-~/.nastech}/.env`.
...
```bash
python3 ~/.nastech/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.nastech/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
