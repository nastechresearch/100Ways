...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/creative/audiocraft-audio-generation` |
...
- **[Advanced Usage](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/creative/audiocraft-audio-generation/references/advanced-usage.md)** - Training, fine-tuning, deployment
- **[Troubleshooting](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/creative/audiocraft-audio-generation/references/troubleshooting.md)** - Common issues and solutions
