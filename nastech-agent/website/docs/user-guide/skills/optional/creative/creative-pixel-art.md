...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.nastech/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.nastech/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Nastech installs package this)
