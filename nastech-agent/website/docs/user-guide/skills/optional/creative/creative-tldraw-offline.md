...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative/tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + Nastech Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This Nastech skill mirrors that guidance for Nastech.)
