...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/mlops/segment-anything-model` |
...
# Load model
sam = sam_model_registry["vit_h"](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/models/segment-anything-model/checkpoint="sam_vit_h_4b8939.pth")
sam.to(device="cuda")
...
sam = sam_model_registry["vit_b"](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/models/segment-anything-model/checkpoint="sam_vit_b_01ec64.pth")
...
- **[Advanced Usage](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/advanced-usage.md)** - Batching, fine-tuning, integration
- **[Troubleshooting](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/troubleshooting.md)** - Common issues and solutions
