...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/mlops/tensorrt-llm` |
...
- **[Optimization Guide](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/tensorrt-llm/references/optimization.md)** - Quantization, batching, KV cache tuning
- **[Multi-GPU Setup](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/tensorrt-llm/references/multi-gpu.md)** - Tensor/pipeline parallelism, multi-node
- **[Serving Guide](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/tensorrt-llm/references/serving.md)** - Production deployment, monitoring, autoscaling
