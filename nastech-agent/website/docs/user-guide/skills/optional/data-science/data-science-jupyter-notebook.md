...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing nastech tool access (web_search, file ops). Stateless. |
