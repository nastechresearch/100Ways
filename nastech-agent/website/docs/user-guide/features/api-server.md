...
sidebar_position: 14
title: "API Server"
description: "Expose nastech-agent as an OpenAI-compatible API for any frontend"
---
...
| `API_SERVER_MODEL_NAME` | _(profile name)_ | Model name on `/v1/models`. Defaults to profile name, or `nastech-agent` for default profile. |
