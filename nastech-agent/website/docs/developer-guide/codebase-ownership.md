...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `nastech_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `nastech_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Nastech Plugin](plugins/index.md) |
...
| Session storage | `nastech_state.py` | [Session Storage](session-storage.md) |
