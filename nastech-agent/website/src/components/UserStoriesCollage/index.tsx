  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/NastechResearch/nastech-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/NastechResearch" target="_blank" rel="noopener noreferrer">
          Nastech Research Discord
        </a>{' '}
