...
| | |
|---|---|
| 来源 | 可选 — 通过 `nastech skills install official/blockchain/solana` 安装 |
| 路径 | `optional-skills/blockchain/solana` |
| 版本 | `0.2.0` |
| 作者 | Deniz Alagoz (gizdusum)，由 Nastech Agent 增强 |
| 许可证 | MIT |
...
辅助脚本路径：~/.nastech/skills/blockchain/solana/scripts/solana_client.py
...
# 确认连通性
python3 ~/.nastech/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.nastech/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.nastech/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.nastech/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.nastech/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.nastech/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
