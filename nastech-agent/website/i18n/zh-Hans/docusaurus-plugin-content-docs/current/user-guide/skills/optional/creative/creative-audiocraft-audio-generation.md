...
| | |
|---|---|
| 来源 | 可选 — 通过 `nastech skills install official/creative/audiocraft-audio-generation` 安装 |
...
- **[高级用法](https://github.com/NastechResearch/nastech-agent/blob/main/skills/mlops/models/audiocraft/references/advanced-usage.md)** - 训练、微调、部署
- **[故障排查](https://github.com/NastechResearch/nastech-agent/blob/main/skills/mlops/models/audiocraft/references/troubleshooting.md)** - 常见问题与解决方案
