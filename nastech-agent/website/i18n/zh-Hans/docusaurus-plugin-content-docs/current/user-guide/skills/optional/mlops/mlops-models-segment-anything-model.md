...
| | |
|---|---|
| 来源 | 可选 — 通过 `nastech skills install official/mlops/segment-anything` 安装 |
...
- **[高级用法](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/advanced-usage.md)** - 批处理、微调、集成
- **[故障排查](https://github.com/NastechResearch/nastech-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/troubleshooting.md)** - 常见问题与解决方案
