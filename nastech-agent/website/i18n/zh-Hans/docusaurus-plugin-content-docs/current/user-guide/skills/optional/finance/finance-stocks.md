...
| | |
|---|---|
| 来源 | 可选 — 使用 `nastech skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Nastech Agent |
| 许可证 | MIT |
...
```
SCRIPT=~/.nastech/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.nastech/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
