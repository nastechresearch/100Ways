...
Data file: $NASTECH_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NASTECH_HOME = Path(os.environ.get("NASTECH_HOME", Path.home() / ".nastech"))
DATA_DIR = _NASTECH_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
